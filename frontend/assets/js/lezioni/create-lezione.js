// /Applications/MAMP/htdocs/yoga00/frontend/assets/js/lezioni/create-lezione.js
        ...
        <div class="card-body">
          <form id="formNuovaLezione" action="#" method="post">
            ...
            <div class="d-grid gap-2">
              ...
              <button type="button" class="btn btn-secondary" onclick="mostraLezioni()" disabled>
...
`;
  ...
  $(document).on('submit', '#formNuovaLezione', function (e) {
    ...
    // Costruisco l'oggetto manualmente
    const datiLezione = {
