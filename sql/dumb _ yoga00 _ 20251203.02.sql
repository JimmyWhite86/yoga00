...
--
-- Host: localhost:8889
-- Creato il: Dic 03, 2025 alle 16:05
...
CREATE TABLE `acquisti` (
  ...
  `abbonamento_id` int(11) NOT NULL,
  `data_acquisto` date NOT NULL DEFAULT '2025-01-01',      /* Con CURRENT_DATE mi dava errori nel db. Gestirò questa data tramite PHP */
...
CREATE TABLE `utenti` (
  ...
  `data_scadenza_visita_medica` date DEFAULT NULL,
