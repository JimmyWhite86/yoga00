...
--
-- Host: localhost:8889
-- Creato il: Dic 17, 2025 alle 18:21
...
(11, 'XXX', 'Quarta prova di modifica', '120.00', 10, 180),
(12, 'Prova secondo inserimento', '10 lezioni valide 6 mesi', '120.00', 10, 180),
(13, 'Prova secondo inserimento', '10 lezioni valide 6 mesi', '120.00', 10, 180),
(14, 'Prova terzo inserimento', '10 lezioni valide 6 mesi', '120.00', 10, 180);
...
(2, 1, 3, '2030-11-15', '2030-12-15', 2, 1),
...
(11, 1, 1, '2025-11-01', '2026-04-30', 666, 1),
(12, 1, 1, '2025-11-01', '2026-04-30', 999, 1);
...
(5, 0, 'Prova modifica', 'Verdi', '1990-05-15', 'mario.verdi@email.it', '$2y$10$eF8X8Qz2vG9kL5nQwErT/.3fK8vX8Qz2vG9kL5nQwErT/.3fK8vX8Q', '2025-12-06 16:08:43'),
...
--
ALTER TABLE `abbonamenti`
  MODIFY `abbonamento_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT per la tabella `acquisti`
--
ALTER TABLE `acquisti`
  MODIFY `acquisto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
